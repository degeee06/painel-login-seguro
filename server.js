...
// ==========================
// Rotas USER (LOGIN - que estavam faltando)
// ==========================
app.post('/login', async (req, res) => {
  ...
  try {
    ...
    // Inicia contagem se for primeira vez
    if (!user.start_time) {
...
app.listen(PORT, '0.0.0.0', () => {
  ...
  console.log(`🔐 Rotas LOGIN ativas`);
});
